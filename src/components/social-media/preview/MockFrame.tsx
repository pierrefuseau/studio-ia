...
function MobileFrame({ url, children }: { url: string; children: React.ReactNode }) {
  return (
    <div className="relative mx-auto w-[320px] rounded-[2.5rem] border-[3px] border-gray-800 bg-gray-800 shadow-xl">
...
function DesktopFrame({ url, children }: { url: string; children: React.ReactNode }) {
  return (
    <div className="mx-auto w-full max-w-[600px] overflow-hidden rounded-xl border border-gray-200 bg-white shadow-lg">
